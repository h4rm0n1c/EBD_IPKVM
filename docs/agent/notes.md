...
- VSYNC IRQs are deglitched with a ~12–23 ms interval window, resync after long gaps, captures are gated to ~30 fps by time, and capture auto-aborts after ~50 ms if HSYNC stalls.
