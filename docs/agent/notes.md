...
- If HSYNC edge polarity is flipped without retuning XOFF, the capture window can straddle horizontal blanking and produce a stable but incorrect black band; treat HSYNC edge toggles as a calibration action, not a stability fix.
