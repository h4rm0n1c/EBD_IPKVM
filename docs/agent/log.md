...
- 2026-01-27: Deglitched VSYNC with interval filtering and time-based ~30 fps gating; resync after long gaps; phase-locked PIXCLK on a post-HSYNC falling edge in all PIO line programs.
