...
- 2026-02-12: Add a short debounce on ADB GPIO rise IRQs and enable a weak pull-up on GPIO6 to reduce spurious IRQ storms when the bus is floating.
...
- 2026-02-13: Size IO_IRQ_BANK0 intr snapshots using count_of(io_bank0_hw->intr) to avoid undefined NUM_BANK0 IRQ constants across SDKs.
