...
- 2026-01-27: Deglitched VSYNC with interval filtering and time-based ~30 fps gating; resync after long gaps and on mid-frame VSYNC; added a ~50 ms capture timeout to recover from stalls; phase-locked PIXCLK on a post-HSYNC falling edge in all PIO line programs.
