...
- 2026-02-09: Allow the bulk stream writer to coalesce multiple line packets into one USB transfer so writes scale with available bandwidth without changing packet framing.
