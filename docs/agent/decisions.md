...
- 2026-01-27: Deglitch VSYNC using an interval filter (~12–23 ms), resync after long gaps, gate capture by time (~32 ms), and abort stalled capture windows after ~50 ms.
