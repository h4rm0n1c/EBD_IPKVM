...
If you enable **Boot for ROM disk** before starting a session, the web backend asserts the ROM-disk chord (`Command+Option+X+O`) before power-on and holds it through the first ~45 seconds.
